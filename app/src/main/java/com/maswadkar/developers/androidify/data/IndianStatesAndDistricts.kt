 ...
 * This avoids expensive Firestore queries for populating dropdowns.
 */
object IndianStatesAndDistricts {

    /**
     * Returns sorted list of all Indian states and union territories
     */
    fun getStates(): List<String> = STATES.sorted()

    /**
     * Returns sorted list of districts for a given state
     */
    fun getDistricts(state: String): List<String> {
        return STATE_DISTRICTS[state]?.sorted() ?: emptyList()
    }
    ...
    private val STATE_DISTRICTS = mapOf(
        ...
        "Arunachal Pradesh" to listOf(
            ...
            "Longding", "Kamle", "Lepa Rada", "Pakke Kessang", "Shi Yomi"
        ),
        "Assam" to listOf(
        ...
        "Rajasthan" to listOf(
            ...
            "Jaipur Rural", "Jodhpur Rural", "Kekri", "Khairthal-Tijara",
