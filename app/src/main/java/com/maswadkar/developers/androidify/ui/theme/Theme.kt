...
val LocalChatColors = staticCompositionLocalOf {
    ChatColors(
        ...
        modelBubble = ModelBubbleLight,
        modelBubbleText = Color.Black
    )
}
...
fun KrishiMitraTheme(
    ...
    val chatColors = if (darkTheme) {
        ChatColors(
            ...
            modelBubble = ModelBubbleDark,
            modelBubbleText = Color.White
        )
    } else {
        ChatColors(
            userBubble = UserBubbleLight,
...
// Extension to access chat colors
object KrishiMitraTheme {
